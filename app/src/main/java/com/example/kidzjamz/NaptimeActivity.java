...
public class NaptimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_naptimeplaylist);

        //add music file to newly created object music
        music=MediaPlayer.create(this, R.raw.naptimesongs);
    }
